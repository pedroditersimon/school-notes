...
public class GenericService<T, Tid>(IUnitOfWork unitOfWork, IRepository<T, Tid> repository) : IGenericService<T, Tid>
{
    protected readonly IUnitOfWork _unitOfWork = unitOfWork;
    protected readonly IRepository<T, Tid> _repository = repository;
